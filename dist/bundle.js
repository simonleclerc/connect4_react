...
var reducers_1 = __webpack_require__(40);
var react_redux_1 = __webpack_require__(14);
var Header_container_1 = __webpack_require__(57);
...
ReactDOM.render(React.createElement(react_redux_1.Provider, { store: store },
    React.createElement("div", null,
        React.createElement(Header_container_1.default, null),
        React.createElement(Grid_1.Grid, null))), document.getElementById("example"));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var Cell_1 = __webpack_require__(24);
...
var Grid = /** @class */ (function (_super) {
    ...
    function Grid(props) {
        ...
        return _this;
        // let unsubscribe = this.props.store.store.subscribe(() => {
        //     let state = this.props.store.store.getState();
        //
        //     this.setState({activePlayer: state.activePlayer});
        // });
    }
    Grid.prototype.onCellClick = function (cell) {
    };
    // nextPlayer() {
    //     this.props.store.dispatch(toggleActivePlayer());
    // }
...
var model_1 = __webpack_require__(7);
var initialState = {
    activePlayer: model_1.PlayerEnum.RED
};
function activePlayer(state, action) {
    switch (action.type) {
        case actions_1.SET_ACTIVE_PLAYER:
            return action.player;
        case actions_1.TOGGLE_ACTIVE_PLAYER:
            if (state === model_1.PlayerEnum.RED) {
                return model_1.PlayerEnum.YELLOW;
            }
            else {
                return model_1.PlayerEnum.RED;
            }
        default:
            return state;
    }
}
function connect4App(state, action) {
    if (state === void 0) { state = initialState; }
    return {
        activePlayer: activePlayer(state.activePlayer, action)
    };
}
exports.default = connect4App;
 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.SET_ACTIVE_PLAYER = 'SET_ACTIVE_PLAYER';
exports.TOGGLE_ACTIVE_PLAYER = 'TOGGLE_ACTIVE_PLAYER';
/*
 * action creators
 */
function setActivePlayer(player) {
    return { type: exports.SET_ACTIVE_PLAYER, player: player };
}
exports.setActivePlayer = setActivePlayer;
function toggleActivePlayer() {
    return { type: exports.TOGGLE_ACTIVE_PLAYER };
}
exports.toggleActivePlayer = toggleActivePlayer;
...
var HeaderContainer = react_redux_1.connect(mapStateToProps)(Header_1.HeaderComponent);
